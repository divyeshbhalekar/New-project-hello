pipeline {
    ...
    /*   stage ("appln-deployed"){
            ...
            sh "scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/first-pipeline/webapp/target/webapp.war 
            ec2-user@34.239.108.72:/home/ec2-user/apache-tomcat-9.0.58/webapps/"
